type Menu = "vegetariana" | "con carne" | "con pollo";
const menu: Menu = "con pollo";
...
const paginarEntidad = (entity: Object[], page: number) => {
  if (page === 1) {
    let nuevoarray1 = entity.slice(0, 10);
  ...
  if (page === 2) {
    let nuevoarray1 = entity.slice(10, 20);
    const result={
      page:page,
      totalPages: 3,
      items:nuevoarray1
  ...
  if (page === 3) {
    let nuevoarray1 = entity.slice(20, 30);
    const result={
      page:page,
      totalPages: 3,
      items:nuevoarray1
